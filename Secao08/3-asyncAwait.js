...
//      console.log(fase)
//      return fase;
// }).then(fase => console.log('Terminamos na fase: ',fase)).catch(e => console.log(e));

//async -> permite usar a palavra await dentro de uma funcao para esperar um promsse ser executada.
